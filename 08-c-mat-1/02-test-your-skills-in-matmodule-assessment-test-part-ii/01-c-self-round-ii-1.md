...
<h1><strong>IP(Interview Preparation)-Self-Round- II - Assignment 1</strong></h1>
</div>
...
<ol>
<li>Explain what is a smart pointer and what is the main use case of a smart pointer.</li>
