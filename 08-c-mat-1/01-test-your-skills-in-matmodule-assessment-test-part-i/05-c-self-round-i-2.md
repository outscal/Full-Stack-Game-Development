...
<h1><strong>IP(Interview Preparation)-Self-Round- I - Assignment 2</strong></h1>
</div>
...
<ol>
<li>What is an access modifier? Name different access modifiers with the use cases.</li>
