...
<h1><strong>IP(Interview Preparation)-Self-Round- I - Assignment 6</strong></h1>
</div>
...
<ol>
<li>What are user-defined data types? What is the use case of user-defined data types?</li>
