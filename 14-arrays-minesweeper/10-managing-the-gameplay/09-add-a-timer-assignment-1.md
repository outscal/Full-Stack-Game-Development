...
1. Update the `update` method and add `handleGameplay` in the `GameplayManager` class.
2. Add `updateRemainingTime` and `processTimeOver` methods in the `GameplayManager` class.
