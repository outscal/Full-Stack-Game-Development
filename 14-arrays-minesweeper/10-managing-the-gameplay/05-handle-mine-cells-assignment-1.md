...
1. Update the `processCellType` method in the `Board` class. 
2. Add the `processMineCell` method in the `Board` class.
...
1. Add the `revealAllMines` method in the `Board` class. 
2. Play the game.
