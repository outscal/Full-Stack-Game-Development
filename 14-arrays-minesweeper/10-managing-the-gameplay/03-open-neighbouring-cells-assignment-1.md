...
1. Update the `openCell` method in the `Board` class. 
2. Add the `processCellType` method in the `Board` class.
...
1. Implement the `processEmptyCell` method in the `Board` class. 
2. Play the game
