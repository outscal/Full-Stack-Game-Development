...
Now, before we begin, you need to set up SFML for your project!



Let's go through it together step by step:

Make sure to implement the steps without skipping anything!
...
- Inside `**SFML**` folder, you need to copy and paste the `**include**` and `**lib**` directories that you downloaded earlier. 
...
**Note: **You don't need the `place your include and lib folders here` TXT file, it's just a placeholder. Delete it from the SFML folder
...
## STEP 3: ADDING BIN FOLDERS


---

- Open the solution file (`**.sln**`) in Visual Studios 2022 and **run it**. It will throw an error. Don't worry, it is all part of the plan 😉
- After you try to run it, a folder  `**x64/Debug**` will be created inside which you can find your project's executable file (`**.exe**`). 
- Now, all you need to do is **→** copy-paste a few `**.dll**` files from your downloaded `**SFML/bin**` folder into your `**Debug**` folder.
...
> **TODO:**
> **✅**Run the project to crosscheck the errors.
...
You can compare your project with the [solution branch](https://github.com/outscal/Arrays/tree/Project-Setup-Solution) if you couldn't set up the project properly.
