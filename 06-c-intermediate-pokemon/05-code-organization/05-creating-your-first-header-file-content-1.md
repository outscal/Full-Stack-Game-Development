> **NOTE:** Replace `#include "header.hpp"` back to `}` at the end of the main function, 
> and delete `header.hpp` file.
> This was just to show you how header files and `#include` work.



In the previous lesson,

you understood the importance of separating the code into header and source files.

Now, let’s understand the procedure of doing this.



By the end of this chapter, 

you will have a lot of confidence in organizing the code.
...
It is always best to learn things by practising.

Isn't it?



If you try to make the first header file yourself,

you will have more understanding and confidence.



So, I will guide you through every step, and you will try to implement it.

You will create this header file for `PokemonType` enum.



> **NOTE:** Source files are represented by `.cpp` Similarly header files are represented by `.hpp`



> TODO:
> ✅Create a new file in the same folder as your source file
> ✅Rename it as `PokemonType.hpp`
> ✅Remove `PokemonType` enum from the `main.cpp` file
> ✅Write a code of `PokemonType` enum in the header file



Your file directory should look like

![ss](https://outscal-assets.s3.ap-south-1.amazonaws.com/production/LMS/634ff2a63bfd3eecf3cfe038/08_30_2024__11_24_07.png)





Solution - PokemonType.hpp```cpp
...
how you would use this header file in your `main.cpp`



Since `main.cpp` does not know that a header file has been created in the directory,

and it will be used for the `PokemonType` enum.



So, you need to tell this to `main.cpp`
...
You can include the header file in a similar way you used `iostream,`

but here, the syntax will be slightly different. It is given below
...
Like you did it for the `PokemonType` enum,

in a similar way, create a separate header file for `PokemonChoice` enum.



Shift the code of `PokemonChoice` enum in the header file,
