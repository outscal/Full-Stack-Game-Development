> Go to the following link to attempt this assignment: [click here ](https://outscal.com/compiler/reverse-a-string)This link will open a compiler window where you must write your code. 
> 
...
The string contains [a-z] [A-Z] [0-9] [special characters].
