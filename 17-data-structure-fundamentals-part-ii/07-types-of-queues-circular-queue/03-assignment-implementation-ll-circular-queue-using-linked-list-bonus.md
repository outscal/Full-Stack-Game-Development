> Go to the following link to attempt this assignment: [click here](https://outscal.com/compiler/circular-queue-using-linked-list) This link will open a compiler window where you must write your code. After you complete the assignment, you must click the **Save Button** to save your code.
...
1. push(T x) - insert x into queue
2. pop() - remove the front element
3. front() - returns the front element
4. size() - returns the size of queue i.e. number of elements in queue
5. empty() - return true if queue is empty, false otherwise.
