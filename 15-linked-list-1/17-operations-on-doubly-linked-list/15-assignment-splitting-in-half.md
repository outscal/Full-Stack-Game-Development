...
## IMPLEMENTING remove half nodes
...
1. Implement the `removeHalfNodes()` to remove all nodes after the **middle** of the snake size to make the snake size half. 
2. Take reference from `SingleLinkedList`.
