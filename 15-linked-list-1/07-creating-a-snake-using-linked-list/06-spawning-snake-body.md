...
1. Create and implement the following methods: 
2. 1. `insertNodeAtTail()`  
  2. `getNewNodePosition()` 
3. Delete `createHeadNode()` 



## [IN **SNAKECONTROLLER**]

1. Call `SingleLinkedList`'s `insertNodeAtTail()` in for loop from `0 to initial_snake_length`
2. Call `SingleLinkedList`'s `render()`
