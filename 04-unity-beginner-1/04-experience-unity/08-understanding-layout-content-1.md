...
Remember all those Unity panels you've been playing with? Well, it's time to see how they all work together. 
Trust me, this will make your Unity development so much easier!

Think of layouts like different setups for these panels. Depending on what you're working on, you can customize Unity to fit your needs perfectly.
...
Unity's got some cool layouts all ready for you to try:
...
Alright, ready to try these layouts out? Here's how:

1. Look up at the top right corner of Unity.
2. See that 'Layout' dropdown? Click it!
3. Pick the layout you want to try.
4. Don't like what you see? Just drag the panels around until it feels right.
5. Love what you've made? Save it! Just click 'Layout' again and hit 'Save Layout'.



> 💡 **PRO TIP**: 
> Different jobs need different setups. Try the Wide Layout when you're knee-deep in code, or stick with Default for general game design.

> In the next lesson, you’ll learn about Cameras in Unity!
